...
router.put('/jobs/:id', (req, res, next) => Resolver.employerController.updateJob(req, res, next))
router.delete('/jobs/:id', (req, res, next) => Resolver.employerController.deleteJob(req, res, next))
