import { IEmployerRepository } from '@modules/employer/interfaces/IEmployerRepository'
...
export class EmployerRepository implements IEmployerRepository {
  ...
  async getStats(employerId: string): Promise<EmployerStats> {
    ...
    // 2. Get total applications for all jobs of this employer
    // Using a join or subquery logic
