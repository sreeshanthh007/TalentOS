...
// import { employerLogout } from '@/store/slices/employerSlice' // Assuming these exist
...
const employerSidebarItems = [
  ...
  { icon: Users, label: 'Applicants', path: ROUTES.EMPLOYER.JOBS }, // Navigates to jobs first
...
export const AdminLayout: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#051114] text-white flex items-center justify-center">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-teal-400">Admin Dashboard</h2>
        <p className="text-gray-400 mt-2">Coming Soon...</p>
        <Link to={ROUTES.HOME} className="mt-4 inline-block text-teal-500 hover:underline">Back to Home</Link>
      </div>
    </div>
  )
}
